    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            result.forEach(function(personal){
                $("#id1").prepend("<li>"+personal.PER_NAME +" "+ personal.PER_SURNAME+ "->" + personal.ORG_NAME + " <a onclick='addPer(`"+personal.PER_CARDNO+"`)' class='btn btn-info btn-xs' >อัพเดท</a> <span id='id5-"+personal.PER_CARDNO+"' class='text-success'></span></li>")
            })
