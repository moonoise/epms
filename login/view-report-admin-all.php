                  ...
                  <div class="row">
                    <div class="col-md-2 col-sm-2 col-xs-2">
                      <div class="progress" data-toggle="popover" data-id="test" data-placement='right'>
                        <div id="percent_completeID" class='progress-bar progress-bar-success progress-bar-striped active' role='progressbar' aria-pause="" aria-valuenow='0' aria-valuemin='0' aria-valuemax='100' style='width: 0%'>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body" id="modal-body-update-score">
          <div id="id1">
            <p>จำนวนรายชื่อทั้งหมด <b class='text-info' id="id3"></b> ราย </p>
          </div>
          <div id="id4"></div>
