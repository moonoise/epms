...
) ENGINE=InnoDB AUTO_INCREMENT=212714 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT";
...
) ENGINE=InnoDB AUTO_INCREMENT=11774 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT";
...
$kpiScore = "CREATE TABLE $kpiScoreName (
 ...
 `kpi_comment` text COMMENT 'กรณีใส่คะแนนไม่ตรงกันผู้ประเมิน',
...
) ENGINE=InnoDB AUTO_INCREMENT=94469 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT";
...
$kpiScoreResult = "CREATE TABLE $kpiScoreResultName (
 ...
 UNIQUE KEY `per_cardno` (`per_cardno`)
) ENGINE=InnoDB AUTO_INCREMENT=11781 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT";
