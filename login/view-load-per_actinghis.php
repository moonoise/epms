        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="row">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h3><i class="fa  fa-wrench green"></i> <b style="color:red">อัพเดท</b>ผู้ทดลองงาน <small> .. </small></h3>
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <button type="button" class="btn btn-app" id="id0">
                        <i class="fa fa-play green"></i> อัพเดท
                    </button>
                    <div id="id1"><p>จำนวนรายชื่อที่อัพเดททั้งหมด <b class='text-info' id="id3"></b> ราย </p><span id="message"> </span></div>
                    <div id="id4" ></div>
...
// var test;
    $("#id0").on("click",function(){
         ...
         $.ajax({
            url: "module/module_dpis/ajax-query_per_actinghis.php",
            datatype: "json",
            type: "POST",
            success: function (result) {
                ...
                // console.log(result)
                    ...
                    // console.log(result)
                    $('#id3').html(arrResult.length)
                    arrResult.forEach(function(msgPercardno){
                        $('#id2').prepend('<li>'+msgPercardno+'</li>')
                    })
    ...
    function notify(nTitle,nText,nType,timeOut,nHide) {
     ...
     $("#id0").popConfirm({
        title: "อัพเดทผู้ทดลองงาน", // The title of the confirm
        content: "ระบบจะโหลดข้อมูลจาก <b class='text-info'>ระบบ DPIS</b> เข้าการประเมิน<b class='text-info'> ปี รอบ </b>ตัวปัจจุบัน ", // The message of the confirm
