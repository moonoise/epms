...
?>
<!-- Modal -->
<button type='button' class="btn btn-app" data-toggle="confirmation" id="confirm-cpcDefault"  onclick = "cpcDefault(<?php echo "`".$_GET['per_cardno']."`,`".$_GET['pl_code']."`,`".$_GET['level_no']."`"; ?>)" <?php echo $_SESSION[__EVALUATION_ON_OFF__];?> >
                    ...
                    if ($result['success'] == true ){
                        foreach ($result['result'] as $row) {
                            ...
                            echo "<td>
                                    ...
                                    onclick='cpcAdd(`".$_GET['per_cardno']."`,`".$row['question_no']."`,`".$_GET['pl_code']."`,`".$_GET['level_no']."`)' ".$_SESSION[__EVALUATION_ON_OFF__]." >
                                    <i class='fa fa-plus-square'></i></button>
                                    </div>
                                 </td>
                            ";

                            // echo "<td><a href='#' class='btn btn-info btn-xs confirm-add' data-toggle='confirmation' 
                            // onclick='cpcAdd(`".$_GET['per_cardno']."`,`".$row['question_no']."`,`".$_GET['pl_code']."`,`".$_GET['level_no']."`)' disabled>
