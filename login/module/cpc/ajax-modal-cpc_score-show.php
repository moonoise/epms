        ...
        foreach ($cpcType as $key => $value) {
            ...
            foreach ($result['result'] as $row) {
                ...
                echo "<td>  
                        ...
                        <input type='number' class='' style='width: 3em' maxlength='5' min='1' max='5' size='5' value='".$row['cpc_divisor']."' id='divisor-".$row['cpc_score_id']."' ".$_SESSION[__EVALUATION_ON_OFF__].">
