...
if ($_POST['per_name'] != "" and $_POST['org_id'] != "") {
    ...
    LEFT JOIN per_level ON per_level.level_no = " . $currentYear['data']['per_personal'] . ".level_no WHERE " . $currentYear['data']['per_personal'] . ".per_type = '3' AND   (`per_name` LIKE CONCAT('%',SUBSTRING_INDEX(:per_name,' ',1),'%') 
