...
function addSubordinateArr(){
    ...
    $.ajax({
        ...
        type: "POST",
        dataType: "JSON",
        data:{"arrList":arrSubordinate,"per_cardno_head":per_cardno_head},
        success: function (result) {
...
// $("button").find( ".confirm-del-subordinate" ).popConfirm({
//         title: "ลบผู้ใต้บังคับ บัญชา", // The title of the confirm
