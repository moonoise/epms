    ...
    <div class="modal-dialog modal-lg">
        ...
        <form  class="form-horizontal form-label-left" name="form-kpi-edit" id='form-kpi-edit'>
          ...
          <div class="form-group col-md-12 col-sm-12 col-xs-12"  >
              ...
              <div class="col-md-2 col-sm-4 col-xs-12">
              <input type="text" id="kpi_code_org"  class="form-control" name="kpi_code_org" readonly> 
              </div>
          ...
          <div class="form-group col-md-2 col-sm-4 col-xs-12">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 ">
              <select name="kpi_type" id="kpi_type" class="form-control" disabled>
          ...
          <div class="form-group col-md-4 col-sm-4 col-xs-12">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 ">
              <select name="kpi_type2" id="kpi_type2" class="form-control" disabled>
          ...
          <div class="form-group col-md-4 col-sm-4 col-xs-12">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 kpi_type2_show">
              <select name="kpi_con2" id="kpi_con2" class="form-control kpi_type2_show" disabled>
          ...
          <div class="form-group col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col-md-10 col-sm-10 col-xs-12">
              <textarea class="form-control" rows="3"  id="kpi_title" name="kpi_title"   readonly></textarea>
            </div>
          </div>

          <div class="form-group col-md-12 col-sm-12 col-xs-12"  >
              <label class=" col-md-8 col-sm-8 col-xs-12 text-info" for="kpi_level1">คำอธิบายระดับคะแนน 
              </label>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="kpi_level1"  class="form-control" name="kpi_level1" readonly>  
              </div>
              <div class="col-md-4 col-sm-4 col-xs-4">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 kpi_type2_show">
                  <input type="text" id="kpi_rank1"  class="form-control kpi_type2_show" name="kpi_rank1" readonly> 
                </div>
              </div>
          </div>
          ...
          <div class="form-group col-md-12 col-sm-12 col-xs-12" >
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="kpi_level2"  class="form-control" name="kpi_level2" readonly>  
              </div>
              <div class="col-md-4 col-sm-4 col-xs-4">
                <label class="control-label col-md-6 col-sm-6 col-xs-12 text-danger kpi_type2_show" for="kpi_level1"> >= 
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12 kpi_type2_show">
                  <input type="text" id="kpi_rank2"  class="form-control kpi_type2_show" name="kpi_rank2" readonly> 
                </div>
              </div>
          </div>
          ...
          <div class="form-group col-md-12 col-sm-12 col-xs-12"  >
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="kpi_level3"  class="form-control" name="kpi_level3"  readonly>  
              </div>
              <div class="col-md-4 col-sm-4 col-xs-4">
                <label class="control-label col-md-6 col-sm-6 col-xs-12 text-danger kpi_type2_show" for="kpi_level1"> >= 
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12 kpi_type2_show">
                  <input type="text" id="kpi_rank3"  class="form-control kpi_type2_show" name="kpi_rank3"  readonly> 
                </div>
              </div>
          </div>
          ...
          <div class="form-group col-md-12 col-sm-12 col-xs-12"  >
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="kpi_level4"  class="form-control" name="kpi_level4" readonly>  
              </div>
              <div class="col-md-4 col-sm-4 col-xs-4">
                <label class="control-label col-md-6 col-sm-6 col-xs-12 text-danger kpi_type2_show" for="kpi_level1"> >=
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12 kpi_type2_show">
                  <input type="text" id="kpi_rank4"  class="form-control kpi_type2_show" name="kpi_rank4"  readonly> 
                </div>
              </div>
          </div>
          ...
          <div class="form-group col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="kpi_level5"  class="form-control" name="kpi_level5" readonly>  
              </div>
              <div class="col-md-4 col-sm-4 col-xs-4">
                <label class="control-label col-md-6 col-sm-6 col-xs-12 text-danger kpi_type2_show" for="kpi_level1"> >= 
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12 kpi_type2_show">
                  <input type="text" id="kpi_rank5"  class="form-control kpi_type2_show" name="kpi_rank5" readonly> 
                </div>
              </div>
          </div>
...
function refresh_datatable() {
  $.ajax({
       type: "POST",
       url: "module/kpi/ajax-kpi_question-show-all.php",
       dataType: "JSON",
