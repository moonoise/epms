  ...
  <div class="menu_section">
    ...
    <ul class="nav side-menu">
      ...
      <?php if (isset($_SESSION[__USER_ID__]) and in_array($_SESSION[__GROUP_ID__], array(4, 5, 6, 7))) {
        echo " <li><a href='setting-person.php'><i class='fa fa-user text-success'></i> ผู้ประเมิน </a></li>";
        echo " <li><a><i class='fa fa-newspaper-o far fa-newspaper text-success'></i> รายงานภาพรวม <span class='fa fa-chevron-down text-success'></span></a>
                      <ul class='nav child_menu'>
                      <li><a href='view-report-admin-all.php'><i class='fa fa-desktop text-success'></i> ภาพรวม</a></li>";
      ...
      <?php if (isset($_SESSION[__USER_ID__]) and in_array($_SESSION[__GROUP_ID__], array(4, 5, 6))) {
        echo "<li><a><i class='fa fas fa-cog text-success'></i> ตั้งค่าผู้ดูแลระบบ <span class='fa fa-chevron-down'></span></a>
                    <ul class='nav child_menu'>
                    ";
